...
<head>
	...
	<script type="text/javascript" src="${path}/ajax.do?managerName=budgetManagerService"></script>
	<script text="text/javascript">
        ...
        $(function () {
            table = $("#signInPlaceTable").ajaxgrid({				
                ...
                managerName: "budgetManagerService"
            });
            
            var queryParams={"wbs":'${wbs}',"comp":'${comp}',"center":'${center}',"project":'${project}'};
