...
function getEinvoiceFieldInfo() {
    ...
    $.ajax({ url: "/seeyon/rest/cap4/formSapContract/getContractFieldInfo?formid=" + formId+ "&fieldType=" + ""+"&currentField="+params.currentfield.name,
        async:true,
        success: function(data){
            var fields = data.data.budgetMap;
...
function getFormFields(fieldType){
    var params = initParam();
    var formId = params.formBaseInfo.formBaseInfo.formInfo.id;
    $.ajax({ url: "/seeyon/rest/cap4/formSapContract/getSapFields?formid=" + formId + "&fieldType=" + fieldType+"&currentField="+params.currentfield.name,
        async:true,
        success: function(data){
...
function OK(){ 
    ...
    if(checkTag){
        ...
        if(hasSame){
            ...
            $.ajax({ url: "/seeyon/rest/cap4/formSapContract/checkSapMapping",
                async:false,
                type: 'POST',
                dataType:'json',
