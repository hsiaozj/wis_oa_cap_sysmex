(function () {
    var privated = 'field_9568742654604875770';
    var selfA8xHrm = {};
        	...
        	adaptation.adaptation.callTakeFormSave({ type : 'save', mainbodyArgs : { needCheckRule : '0', needDataUnique : '0', needSn : '0' }, isPrev : true, callback : function() {}, successFn : function() {
            	...
            	var subName = messageObj.formdata.formdata.display;
				 current_dialog = $.dialog({
		                url:'/seeyon/signinRembu/signinRembu.do?method=getRembuPage&fieldId='+fieldId+'&formId='+formId+'&formRecordId='+formRecordId+"&subRecordId="+subRecordId+"&subName="+encodeURIComponent(subName),
		                title: "可用预算信息",
		                width: 1000,
		                height: 500,
		                ...
		                buttons: [{
		                    ...
		                    handler: function () {
		                        ...
		                        $.ajax({
		                            type: 'get',
		                            url: _ctxPath + "/rest/cap4/formSapRembu/parseAndFillBackSap",
		                            dataType: 'JSON',
