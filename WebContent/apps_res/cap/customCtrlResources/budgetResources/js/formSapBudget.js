...
function getEinvoiceFieldInfo() {
    ...
    $.ajax({ url: "/seeyon/rest/cap4/formSapBudget/getBudgetFieldInfo?formid=" + formId+ "&fieldType=" + ""+"&currentField="+params.currentfield.name,
        async:true,
...
function getFormFields(fieldType){
    var params = initParam();
    var formId = params.formBaseInfo.formBaseInfo.formInfo.id;
    $.ajax({ url: "/seeyon/rest/cap4/formSapBudget/getSapFields?formid=" + formId + "&fieldType=" + fieldType+"&currentField="+params.currentfield.name,
        async:true,
        success: function(data){
...
function OK(){ 
    ...
    if(checkTag){
        ...
        if(hasSame){
            ...
            $.ajax({ url: "/seeyon/rest/cap4/formSapBudget/checkSapMapping",
                async:false,
                type: 'POST',
                dataType:'json',
