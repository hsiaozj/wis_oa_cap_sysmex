...
public class ProcurementBusinessNode extends BaseSuperNodeAction {
    ...
    public SuperNodeResponse executeAction(String token, String activityId, Map<String, Object> param)  {
        ...
        try{
            ...
            log.info("采购商务合同审批流程模板编号"+templeteNumber);
            ...
            if (form4DataMasterBean != null) {
                ...
                log.info("采购商务合同缓存下来的数据："+documentData);
            ...
            ex.printStackTrace();
            String message="采购商务合同,系统推送数据时出现异常";
            log.info("节点：procurementBusinessNode异常:",ex);
    ...
    public String getNodeId() {
        return "procurementBusinessNode";
    }
