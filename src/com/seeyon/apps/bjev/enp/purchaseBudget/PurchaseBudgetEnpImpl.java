package com.seeyon.apps.bjev.enp.purchaseBudget;
...
public class PurchaseBudgetEnpImpl implements BusinessEnpService{
	private FormDataDAO formDataDAO = (FormDataDAO) AppContext.getBean("formDataDAO");
	private static final Logger log = Logger.getLogger(PurchaseBudgetEnpImpl.class);
...
//		String templateCode = "PurchaseBudget";
		...
		String  MEMBERField =  CAP4FormKit.getFieldTaleId(cap4formBean, "经办人");
		String  UNITField =  CAP4FormKit.getFieldTaleId(cap4formBean, "经办部门");
