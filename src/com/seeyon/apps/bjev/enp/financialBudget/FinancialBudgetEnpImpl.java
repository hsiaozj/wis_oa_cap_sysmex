package com.seeyon.apps.bjev.enp.financialBudget;
...
public class FinancialBudgetEnpImpl implements BusinessEnpService{
	private FormDataDAO formDataDAO = (FormDataDAO) AppContext.getBean("formDataDAO");
	private static final Logger log = Logger.getLogger(FinancialBudgetEnpImpl.class);
...
//		String templateCode = "FinancialBudget";
		...
		String  MEMBERField =  CAP4FormKit.getFieldTaleId(cap4formBean, "SAP申请人");
		String  UNITField =  CAP4FormKit.getFieldTaleId(cap4formBean, "SAP申请部门");
