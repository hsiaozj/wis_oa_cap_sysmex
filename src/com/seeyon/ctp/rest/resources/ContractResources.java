...
@Path("cap4/formSapContract")
@Consumes({MediaType.APPLICATION_JSON})
@Produces({MediaType.APPLICATION_JSON})
public class ContractResources extends BaseResource{
	private static Log log = LogFactory.getLog(ContractResources.class);
